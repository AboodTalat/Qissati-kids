...
export const en = {
  lang: "en",
  meta: {
    title: "Personalised Children's Storybooks in Jordan | Qissati",
    description:
      "Personalised illustrated children's storybooks in Jordan, written from scratch around your child's name, personality and adventures. Available as a PDF or printed book.",
    ...
    ogLocale: "en_US",
    socialImageAlt:
      "Qissati logo: a child reaching for a star from an open storybook",
  },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Choose simple Modern Standard Arabic, Jordanian Arabic or English. We also adapt the vocabulary and sentence length to your child's age.",
      },
      {
        q: "What makes Qissati different from a name-swapped story?",
        a: "Every fully personalised Qissati story is written from scratch around the child's personality, interests, meaningful details and chosen adventure. Their name is part of the story, not the only thing that changes.",
      },
      {
        q: "Where does Qissati deliver?",
        a: "Qissati is based in Jordan. Digital PDF stories are delivered electronically, and printed storybooks are delivered within Jordan.",
      },
      {
